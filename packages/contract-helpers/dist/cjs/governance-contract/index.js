...
class AaveGovernanceService extends BaseService_1.default {
    ...
    async delegateTokensBySig({ user, tokens, data }) {
        const helper = IGovernanceV2Helper__factory_1.IGovernanceV2Helper__factory.connect(this.aaveGovernanceV2HelperAddress, this.provider);
        const txCallback = this.generateTxCallback({
            rawTxMethod: async () => helper.populateTransaction.delegateTokensBySig(tokens, data),
            from: user,
        });
        return [
            {
    ...
    async delegateTokensByTypeBySig({ user, tokens, data }) {
        const helper = IGovernanceV2Helper__factory_1.IGovernanceV2Helper__factory.connect(this.aaveGovernanceV2HelperAddress, this.provider);
        const txCallback = this.generateTxCallback({
            rawTxMethod: async () => helper.populateTransaction.delegateTokensByTypeBySig(tokens, data),
            from: user,
        });
        return [
            {
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AaveGovernanceService.prototype, "delegateTokensBySig", null);
tslib_1.__decorate([
    methodValidators_1.GovHelperValidator,
    tslib_1.__param(0, (0, paramValidators_1.isEthAddress)('user')),
    tslib_1.__param(0, (0, paramValidators_1.isEthAddressArray)('tokens')),
    ...
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AaveGovernanceService.prototype, "delegateTokensByTypeBySig", null);
